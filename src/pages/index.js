    ...
    <>
      ...
      <div className={cx(commonCss.section, styles.introduce)}>
        ...
        <div className={cx(commonCss.sectionBox, commonCss.sectionContent)}>
          ...
          <hr />
          <p>
            디시인사이드의 개방성을 모토로 프로그래밍 갤러리 유저들 간
            기술교류를 통해 유저들의 프로그래밍 능력을 향상시키고 네트워킹을
            활성화합니다.
          </p>
        </div>
      </div>
        ...
        <div className={cx(commonCss.sectionBox, commonCss.sectionContent)}>
          ...
          <ol>
            ...
            <li>
              ...
              활성화하고 이를 통해 유저들 간 프로그래밍 지식과 기술 교류에
              이바지
            </li>
            <li>
      ...
      <div className={cx(commonCss.section, styles.about)}>
        ...
        <div className={cx(commonCss.sectionBox, commonCss.sectionContent)}>
          ...
          <hr />
          <p>
            디시인사이드 프로그래밍 갤러리 유저들과 함께 첫 프로그래밍 갤러리
            컨퍼런스를 추진하게 되었습니다.
          </p>
          <p>
            디시인사이드는 여타 커뮤니티와 달리 예의나 체면치레에서 자유로우며,
            이를 통해 나이와 환경을 뛰어넘고 다양한 배경에서 유래한 프로그래밍
            이야기를 한 곳에서 담아낼 수 있는 유일무이한 커뮤니티가 되었습니다.
          </p>
          <p>
            이번 컨퍼런스는 디시인사이드의 자유로운 분위기를 담아내어 “누구나
            강연할 수 있고, 누구나 정보를 얻어갈 수 있는” 컨퍼런스가 되는 것을
            목표로 합니다.
          </p>
          <p>
          ...
          <p>
            커뮤니티 페이지의 높은 생산성은 그 하나만으로도 다양한 인터넷
            이용자들의 발걸음을 끌어당깁니다. 이번 컨퍼런스를 계기로 프로그래밍
            갤러리가 자유롭게 양질의 정보를 나눌 수 있는 장이 된다면
